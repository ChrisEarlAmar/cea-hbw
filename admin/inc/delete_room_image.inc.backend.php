...
if (isset($_GET['id'])) {
    ...
    $fetchQuery = "SELECT picture FROM room_images WHERE sr_no = ?";
    ...
    if ($fetchStmt->execute()) {
        ...
        if ($fetchStmt->fetch()) {
            $basePath = "C:/wamp64/www/cea-hbw/assets/images/rooms/";
            ...
            if (file_exists($filePath) && unlink($filePath)) {
                ...
                if ($deleteStmt->execute()) {
                    ...
                    require_once('inc/rooms.images.inc.php'); // Refresh the carousel image list
                } else {
